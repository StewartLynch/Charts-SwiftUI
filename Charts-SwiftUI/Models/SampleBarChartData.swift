...
struct SampleBarChartData {
    ...
    static var mySamples:[SampleBarChartData] {
        [
            ...
            SampleBarChartData(year: 2020, month: 0, quantity: 24, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 1, quantity: 65, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 2, quantity: 0, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 3, quantity: 33, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 4, quantity: 42, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 5, quantity: 5, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 6, quantity: 80, itemType: .itemIn),
            SampleBarChartData(year: 2020, month: 7, quantity: 26, itemType: .itemIn),
            ...
            SampleBarChartData(year: 2020, month: 0, quantity: 15, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 1, quantity: 28, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 2, quantity: 18, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 3, quantity: 12, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 4, quantity: 0, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 5, quantity: 29, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 6, quantity: 61, itemType: .itemOut),
            SampleBarChartData(year: 2020, month: 7, quantity: 12, itemType: .itemOut),
